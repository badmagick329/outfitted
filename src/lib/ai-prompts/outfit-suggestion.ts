...
Recent suggestion information is soft preference data. When multiple garments are similarly suitable for the request, prefer garments used less often and less recently. Do not sacrifice occasion suitability, outfit coherence, an explicitly selected garment, or a clear user preference merely for variety. Reuse a recently suggested garment when it is materially better suited or when the wardrobe has no reasonable alternative. A recentSuggestionCount of 0 means the garment has not appeared in the bounded recent history. A lower lastSuggestedPosition means the garment was used more recently. Never treat recent use as a hard exclusion.
